...
class PrimitiveMesh {
public:
    static Mesh* CreateCube(Material* material = nullptr);
    static Mesh* CreateInverseCube(Material* material = nullptr);
    static Mesh* CreateSphere(Material* material = nullptr, unsigned int segments = 32, unsigned int rings = 16, float radius = 1.0f);
    static Mesh* CreatePlane(Material* material = nullptr);
    static Mesh* CreateCylinder(Material* material = nullptr, unsigned int segments = 32, float height = 1.0f, float radius = 0.5f, bool capped = true);
