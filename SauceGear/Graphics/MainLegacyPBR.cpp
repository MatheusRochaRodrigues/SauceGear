...
//    // -------------------------
//    //PBR
//    //Shader pbrShader("pbr.vs", "pbrWithoutIBL.fs");
...
//    float* data = stbi_loadf("resources/Textures/hdr/tst/rogland_moonlit_night_4k.hdr", &width, &height, &nrComponents, 0);
//    //float* data = stbi_loadf("resources/Textures/hdr/limpopo_golf_course_4k.hdr", &width, &height, &nrComponents, 0);
